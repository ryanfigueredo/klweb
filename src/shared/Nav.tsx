      ...
      <nav className="w-full flex justify-center md:gap-20 items-center py-4 z-10 shadow-md md:py-6">
        ...
        <div className="hidden md:flex md:items-center">
          <Link
            ...
            className="bg-[#292B74] text-white text-sm py-2 px-4 rounded hover:bg-blue-900 transition duration-300"
          >
            CONTATO
          </Link>
        </div>
        ...
        <div className="md:hidden">
          ...
          <div
            className={`absolute top-16 my-10 right-0 bg-white shadow-lg w-full transition-opacity duration-300 ${
          ...
          >
            <div className="flex flex-col">
              ...
              <Link
                href="https://wa.me/5541984022907"
                className="bg-[#292B74] text-white text-sm py-2 px-4 rounded hover:bg-blue-900 transition duration-300 block"
              >
                CONTATO
              </Link>
            </div>
