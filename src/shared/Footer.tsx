...
const Footer = () => {
  return (
    <footer className="bg-[#292B74] h-auto pt-5 px-6 md:px-40 w-full ">
      <div className="text-gray-300  flex flex-col md:flex-row items-start justify-between">
        <div>
          <Image
            ...
            priority
            style={{
              filter: "invert(1) brightness(300%) saturate(0%) contrast(400%)",
            }}
          />
        ...
        <div className="md:py-0 py-2 cursor-pointer">
          <ul>
            ...
            <div className="flex py-2">
              ...
              <Link
                href="https://www.linkedin.com/company/klfacilities/"
                className="hover:scale-125 transition duration-50 ease-in-out p-2"
                passHref
                target="_blank"
              >
              ...
              <Link
                href="https://www.facebook.com/profile.php?id=61557548131305"
                className="hover:scale-125 transition duration-50 ease-in-out p-2"
                passHref
                target="_blank"
              >
      ...
      <div className="flex text-slate-500  ">
        <p className="text-sm font-normal hover:text-slate-400 transition duration-150 ease-in-out p-2">
          © 2024 KL Facilities Todos Direitos Reservados
        </p>
        <br />
        <br />
        <a
